...
class Employe
{
     ...
     * @var bool
     *
     * @ORM\Column(name="non_officiel", type="boolean", nullable=true)
     */
    private $nonOfficiel;
    ...
    /**
     * @ORM\OneToOne(targetEntity="PresenceBundle\Entity\Compte_Presence",
    cascade={"persist"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="EmployeBundle\Entity\Societe")
     * @ORM\JoinColumn(nullable=true)
     */
    private $societe;
     ...
     * Set userCompte
     *
     * @param \MPTDN\UserBundle\Entity\User $userCompte
     * @return Employe
     */
    public function setUserCompte(\MPTDN\UserBundle\Entity\User $userCompte = null)
    {
     ...
     * Set societe
     *
     * @param \EmployeBundle\Entity\Societe $societe
     * @return Employe
     */
    public function setSociete(\EmployeBundle\Entity\Societe $societe = null)
    {
     ...
     * Get societe
     *
     * @return \EmployeBundle\Entity\Societe 
     */
     ...
     * Set nonOfficiel
     *
     * @param boolean $nonOfficiel
     * @return Employe
     */
    public function setNonOfficiel($nonOfficiel)
    {
        $this->nonOfficiel = $nonOfficiel;
     ...
     * @return boolean 
     */
    public function getNonOfficiel()
    {
        return $this->nonOfficiel;
    }
}
